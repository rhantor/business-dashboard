...
const SettingsOptions = ({ selectedSettings, setSelectedSettings }) => {
  return (
    <div className="mt-5 ">
      <div className="mt-0 space-y-5 ">
        ...
        <div
          className={`p-3 w-[300px]  flex justify-between items-center gap-2 rounded-xl transition-all duration-300 hover:bg-white hover:border hover:shadow-xl cursor-pointer group   ${
            selectedSettings === "profile" && "active_settings "
          }   `}
        ...
        >
          ...
          <div className="flex-initial group-hover:text-xl group-hover:text-purple-600 transition-all duration-300">
            <MdOutlineArrowRightAlt />
          </div>
        </div>
        <div
          className={`p-3 w-[300px]  flex justify-between items-center gap-2 rounded-xl transition-all duration-300 hover:bg-white hover:border hover:shadow-xl cursor-pointer group  ${
            selectedSettings === "privacy" && "active_settings "
          }  `}
          onClick={() => setSelectedSettings("privacy")}
        >
          <div className="bg-[#8f8f8f] p-1 w-fit rounded-lg flex-initial">
